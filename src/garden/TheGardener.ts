...
import { InteractorSystem } from "../space/interaction/InteractionSystem.ts";
import { getSettings } from "../settings/settingsStore.ts";
import { ObsidianNavigator } from "../adapters/ObsidianNavigator.ts";
import { InputManager } from "../garden/graph/input/InputManager.ts";
import { GraphState } from "../space/GraphState.ts";
import { ObsidianGraphSource } from "../adapters/ObsidianGraphSource.ts";
...
export class TheGardener {
  ...
  private interactor: InteractorSystem | null = null;
  ...
  async open(): Promise<void> {
    ...
    this.interactor = new InteractorSystem({
